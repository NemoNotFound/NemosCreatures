...
public class IceSpiderEntityRenderer<T extends SpiderEntity> extends MobEntityRenderer<T, SpiderEntityModel<T>> {
    ...
    @Override
    protected void scale(T state, MatrixStack matrices, float f) {
