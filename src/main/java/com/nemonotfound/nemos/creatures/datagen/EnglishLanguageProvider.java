...
public class EnglishLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(ModItems.SCORCHED_BONE, "Scorched Bone");
        translationBuilder.add(ModItems.SCORCHED_BONE_MEAL, "Scorched Bone Meal");
        translationBuilder.add(ModItems.SCORCHED_BONE_BLOCK, "Scorched Bone Block");
        translationBuilder.add(ModItems.CRIMSON_BONE, "Crimson Bone");
        translationBuilder.add(ModItems.CRIMSON_BONE_MEAL, "Crimson Bone Meal");
        translationBuilder.add(ModItems.CRIMSON_BONE_BLOCK, "Crimson Bone Block");
        translationBuilder.add(ModItems.WARPED_BONE, "Warped Bone");
        translationBuilder.add(ModItems.WARPED_BONE_MEAL, "Warped Bone Meal");
        translationBuilder.add(ModItems.WARPED_BONE_BLOCK, "Warped Bone Block");
    }
}
