...
public class ModEntityModels {
    ...
    private static final TexturedModelData armorModelData = TexturedModelData.of(ArmorEntityModel.getModelData(ARMOR_DILATION), 64, 32);
    ...
    public static void bootstrap() {
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.VENOMOUS_SKELETON_OUTER, () -> TexturedModelData.of(BipedEntityModel.getModelData(OUTER_DILATION, 0.0f), 64, 32));
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.VENOMOUS_SKELETON_OUTER_PANTS, () -> TexturedModelData.of(BipedEntityModel.getModelData(new Dilation(0.25f), 0.0f), 64, 32));
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.VENOMOUS_SPIDER, SpiderEntityModel::getTexturedModelData);
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.VENOMOUS_CREEPER_OUTER, () -> CreeperEntityModel.getTexturedModelData(OUTER_DILATION));
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.VENOMOUS_ZOMBIE_OUTER, () -> TexturedModelData.of(ZombieEntityModel.getModelData(OUTER_DILATION, 0f), 64, 64));
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.VENOMOUS_ZOMBIE_BABY_OUTER, () -> TexturedModelData.of(ZombieEntityModel.getModelData(OUTER_DILATION, 0f), 64, 64).transform(BipedEntityModel.BABY_TRANSFORMER));
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.SCORCHED_CREEPER_OUTER, () -> CreeperEntityModel.getTexturedModelData(OUTER_DILATION));
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.MUMMY_OUTER, () -> TexturedModelData.of(BipedEntityModel.getModelData(new Dilation(0.25f), 0.0f), 64, 64));
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.MUMMY_BABY_OUTER, () -> TexturedModelData.of(BipedEntityModel.getModelData(new Dilation(0.25f), 0.0f), 64, 64).transform(BipedEntityModel.BABY_TRANSFORMER));
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.SNOWY_SKELETON_OUTER, () -> TexturedModelData.of(BipedEntityModel.getModelData(OUTER_DILATION, 0.0f), 64, 32));
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.SNOWY_CREEPER_OUTER, () -> CreeperEntityModel.getTexturedModelData(OUTER_DILATION));
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.SNOWY_ZOMBIE_OUTER, () -> TexturedModelData.of(ZombieEntityModel.getModelData(OUTER_DILATION, 0f), 64, 32));
        ...
        EntityModelLayerRegistry.registerModelLayer(ModEntityModelLayers.SNOWY_ZOMBIE_BABY_OUTER, () -> TexturedModelData.of(ZombieEntityModel.getModelData(OUTER_DILATION, 0f), 64, 32).transform(BipedEntityModel.BABY_TRANSFORMER));
